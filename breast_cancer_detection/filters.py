...
DEFAULT_CONFIG_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), "filter_config.json")
...
class ImageFilterProcessor:
    ...
    def process_images_in_folder(self, input_folder, output_folder, filter_name):
        ...
        image_files = [f for f in input_path.iterdir() if f.suffix.lower() in self.VALID_EXTENSIONS]
